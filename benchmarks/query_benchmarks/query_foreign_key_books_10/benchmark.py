...
class QueryValuesForeignKey10TotalBooks(QueryValuesForeignKeyRatioBase):
    _author = LargeAuthor
    _book = LargeBook
...
# QueryValuesForeignKey10TotalBooks = generate_foreign_key_benchmark(
#     "QueryValuesForeignKey10TotalBooks", LargeAuthor, LargeBook, TOTAL_BOOKS
# )
